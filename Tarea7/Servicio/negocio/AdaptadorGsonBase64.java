...
{
	/* Esta clase permite modificar la forma en que GSON serializa los campos con tipo byte[]
		GSON los convierte en ua lista de numeros separados por comas, esta clase los convierte a base 64.
	*/
